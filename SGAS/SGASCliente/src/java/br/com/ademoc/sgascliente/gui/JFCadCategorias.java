 ...
 * @author Deda
 */
public class JFCadCategorias extends javax.swing.JFrame {
...
private void jBSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBSalvarActionPerformed
    ...
    try {
        ...
        ex.printStackTrace();
        JOptionPane.showMessageDialog(null, "Erro ao Gravar Categoria", "Aviso", JOptionPane.ERROR_MESSAGE);
    }
...
private void jBSairKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jBSairKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFCadCategorias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new JFCadCategorias().setVisible(true);
            }
        });
    }
